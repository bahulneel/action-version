 ...
 */
export declare abstract class BaseGitOperationStrategy implements GitOperationStrategy {
     ...
     */
    abstract commitVersionChange(packageDir: string, packageName: string, version: string, bumpType: BumpType, template: string): Promise<void>;
    /**
     ...
     * @param template - The commit message template
     */
    abstract commitDependencyUpdate(packageDir: string, packageName: string, depName: string, depVersion: string, template: string): Promise<void>;
    /**
     ...
     */
    abstract tagVersion(version: string, isPrerelease: boolean, shouldTag: boolean): Promise<void>;
}
